...
状态：v1.1 视觉更新已实现并完成构建，2026-09-17。竖屏封面在 `PENALTY` 下新增固定中文游戏名“点球决胜”，当前草坪素材统一改为横向明暗条纹，门将改穿黑色球衣；横屏标题页不再显示 `MAKE IT COUNT.`／“一球定胜负”。v1.0 的六格射门规则、90%／65%／25% 校准进球率、中英文界面与语言持久保存均保持不变。确切证据见[安装说明、验证记录与真机清单](docs/validation.zh_CN.md)，真机验收仍待完成。
