...
// Caller holds the LVGL lock. Use hardware rotation with the existing partial
// buffer. Landscape maps logical (x,y) to portrait (y, H-1-x): image turns left,
// device is held clockwise. False restores the baseline portrait orientation.
