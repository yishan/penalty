...
// Tail events of a physical press retain its epoch across page transitions.
unsigned demo_navigation_event_epoch(unsigned current, unsigned *press_epoch, bool is_press);
